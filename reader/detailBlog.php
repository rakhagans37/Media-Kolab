...
$queryTag = "SELECT tb_blog_tag.tag_id, tb_tag.tag_name FROM tb_blog_tag INNER JOIN tb_tag ON tb_tag.tag_id = tb_blog_tag.tag_id WHERE tb_blog_tag.blog_id = '$blogId'";
