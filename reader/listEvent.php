...
if (is_null($getCategory)) {
	$query = "SELECT tb_event.event_url, tb_event.event_title, tb_event.date_release, tb_event.image_url, tb_editor.username, tb_category.category_name FROM tb_event INNER JOIN tb_editor ON tb_event.editor_id = tb_editor.editor_id INNER JOIN  tb_category ON tb_category.category_id = tb_event.category_id";
} else {
	$query = "SELECT tb_event.event_url, tb_event.event_title, tb_event.date_release, tb_event.image_url, tb_editor.username, tb_category.category_name FROM tb_event INNER JOIN tb_editor ON tb_event.editor_id = tb_editor.editor_id INNER JOIN  tb_category ON tb_category.category_id = tb_event.category_id WHERE tb_category.category_name = '$getCategory'";
}

$data = mysqli_query($conn, $query);
$result = mysqli_fetch_all($data);
$query2 = "SELECT tb_event.category_id, tb_category.category_name, COUNT(tb_event.category_id) AS jumlah_kategori FROM tb_category INNER JOIN tb_event ON tb_category.category_id = tb_event.category_id GROUP BY tb_event.category_id";
										...
										<div class="col-sm-6">
											...
											<div class="post post-grid rounded bordered">
												...
												<div class="details">
													...
													<h5 class="post-title mb-3 mt-3"><a href="detailEvent.php?eventUrl=$eventUrl">$eventTitle</a></h5>
												</div>
